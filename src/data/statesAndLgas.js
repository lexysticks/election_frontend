export const statesAndLgas = {
  ...
  "Benue": [
    ...
    "Ogbadibo", "Ohimini", "Oju", "Okpokwu", "Oturkpo", "Tarka",
  ...
  "Jigawa": [
    ...
    "Kafin Hausa", "Kaugama", "Kazaure", "Kiri Kasama", "Kiyawa",
  ...
  "Kano": [
    ...
    "Garun Mallam", "Gaya", "Gezawa", "Gwale", "Gwarzo", "Kabo",
    "Kano Municipal", "Karaye", "Kibiya", "Kiru", "Kumbotso", "Kunchi",
    "Kura", "Madobi", "Makoda", "Minjibir", "Nasarawa", "Rano",
  ...
  "Kwara": [
    ...
    "Ilorin West", "Irepodun", "Isin", "Kaiama", "Moro", "Offa",
    "Oke Ero", "Oyun", "Pategi"
  ],
